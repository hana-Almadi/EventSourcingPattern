...
namespace account_event_sourcing.Migrations
{
    ...
    [Migration("20220306122622_add_onDelete_AccountAggergateId")]
    partial class add_onDelete_AccountAggergateId
    {
            ...
            modelBuilder.Entity("account_event_sourcing.Domain.Event.DomainEvent", b =>
                {
                    b.HasOne("account_event_sourcing.Domain.AccountAggergate", "AccountAggergate")
                        .WithOne("DomainEvent")
                        .HasForeignKey("account_event_sourcing.Domain.Event.DomainEvent", "AccountAggergateId")
